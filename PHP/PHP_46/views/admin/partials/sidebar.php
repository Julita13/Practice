<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= url('adminlte/index3.html" class="brand-link') ?>">
      ...
      <span class="brand-text font-weight-light">Your admin</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= url('adminlte/dist/img/112574073.jpg') ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    with font-awesome or any other icon font library -->
                      ...
                      <li class="nav-item">
                          <a href="<?= url('admin/movies/index.php'); ?>" class="nav-link">
