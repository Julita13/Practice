...
<body>
    ...
    <form action="register_contest.php" method="POST">
        ...
        <input type="text" name="name" value="<?= $oldData['name'] ?? "" ?>"><br>

        <label for="age">Age:</label><br>
        <input type="number" name="age" value="<?= $oldData['age'] ?? "" ?>"><br>

        <label for="breed">Breed:</label><br>
        <input type="text" name="breed" value="<?= $oldData['breed'] ?? "" ?>"><br>

        <label for="weight">Weight: </label><br>
        <input type="number" name="weight" value="<?= $oldData['weight'] ?? "" ?>"><br>

        <label for="height">Height: </label><br>
        <input type="number" name="height" value="<?= $oldData['height'] ?? "" ?>"><br><br>
